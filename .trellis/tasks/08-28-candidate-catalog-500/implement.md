...
> 当前状态：仅规划，未启动。所有条目保持未勾选，待 `prd.md`、`design.md` 和审计报告评审通过后，才能运行 Trellis start 并进入实现。
...
- [ ] 3.3 新增 `validate_external_dining_seed.py`
